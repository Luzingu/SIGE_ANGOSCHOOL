...
window.onload=function(){
    ...
    $("#dataNascAluno, #sexoAluno, #nomeAluno, #nomePai, #nomeMae").bind("change, keyup", function(){
...
function fazerPesquisa(){
  ...
  $("#numTMasculinos").text(0);
    ...
    alunosInscritos.forEach(function(dado){
        ...
        +completarNumero(contagem)+"</td><td class='lead'>"+dado.nomeAluno
        +"</td><td class='lead text-center'>"+vazioNull(dado.sexoAluno)
        +"</td><td class='lead text-center'>"+converterData(dado.dataInscricao)
      ...
      "<i class='fa fa-print'></i></a></td><td class='text-center'>"+
        ...
        +"'><i class='fa fa-pen'></i></a><a class='btn btn-danger' n='' title='Excluir' href='#a' action='excluirCadastro' idPrincipal='"+dado.idPAluno
...
function porValoresNoFormulario(){
 alunosInscritos.forEach(function(dado){
      ...
      if(dado.idPAluno==idPrincipal){
            ...
            $("#formularioCadastro #rpm").val(dado.rpm);
