<?php session_start();
    ...
    includar("../../");
    $manipulacaoDados = new manipulacaoDados("Pauta de Conselho de Notas", "pautaConselhoNotas1");
...
<body>
  ...
  <section id="main-content">
        <section class="wrapper" id="containers">
           <div class="row" >
              ...
              <nav role="navigation" class="navbar navbar-inverse paternSubMenuInterno" >
                  ...
                  <h1 class="lead navbar-brand" style="color: white;"><i class="fa fa-users"></i><strong id="pGeral"> Conselho de Notas</strong></h1>
            </nav>
            </div>
          </div>
          <div class="main-body">
        ...
        $superConselho=isset($_GET["superConselho"])?$_GET["superConselho"]:"nao";

        $permiPeda = $verificacaoAcesso->verificarAcesso("", ["pautaConselhoNotas1"], array(), "");
        if(!$permiPeda){
          $superConselho="nao";
        }
        echo "<script>var superConselho='".$superConselho."'</script>";
        ...
        if($permiPeda || count($manipulacaoDados->selectArray("listaturmas", ["idPresidenteConselho"], ["idPresidenteConselho"=>$_SESSION["idUsuarioLogado"], "idListaAno"=>$manipulacaoDados->idAnoActual, "idPEscola"=>$_SESSION['idEscolaLogada']], [], 1))>0){
          ...
          $planoCurricular = $manipulacaoDados->disciplinas ($idCurso, $classe, $periodo, "", array(), [58, 59, 60, 231, 232, 233], ["idPNomeDisciplina", "disciplinas.classeDisciplina", "disciplinas.semestreDisciplina", "disciplinas.semestreDisciplina", "disciplinas.tipoDisciplina", "nomeDisciplina"]);
  ...
  <div class="row" id="dadosAlunos">
    ...
    <div class="row">
      <div class="col-lg-8 col-md-8 lead">
        Total: <strong class="badge bg-primary" id="total">00</strong>
        &nbsp;&nbsp;&nbsp;
        Feminino: <strong class="badge bg-primary" id="totalF">00</strong>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

        Aprovados: <strong class="badge bg-success" id="totalAprov">00</strong>
        &nbsp;&nbsp;&nbsp;
        Feminos: <strong class="badge bg-success" id="totalAprovFem">00</strong>
      </div>
    ...
    <div class="row">
      <div class="col-lg-12 col-md-12">
        <a href="<?php echo "../../relatoriosPdf/pautas/?turma=".$turma."&classe=".$classe."&idPCurso=".$idCurso."&listarTodas=YXM&trimestreApartir=4&mesPagamentoApartir=0&tamanhoFolha=A3&tipoPauta=pautaGeral&resultPauta=naoDefinitivo"; ?>" class="btn btn-primary btn-lg"><i class="fa fa-print"></i> Pauta</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="<?php echo "../../relatoriosPdf/actaConselhoTurmas.php?turma=".$turma."&classe=".$classe."&idPCurso=".$idCurso; ?>" class="btn btn-primary btn-lg"><i class="fa fa-print"></i> Acta</a>
