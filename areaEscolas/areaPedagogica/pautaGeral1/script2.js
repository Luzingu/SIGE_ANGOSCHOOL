  ...
  window.onload=function(){
      ...
      $("#visualizarMiniPauta").click(function(){
        ...
        if($("#listaDisciplinas").val()!=""){
          ...
          +"&trimestreApartir="+trim+"&idPDisciplina="+$("#listaDisciplinas").val();
        } 
      })
      $(".visualizarPauta").click(function(){
        ...
        +$("#tamanhoFolha").val()+"&tipoPauta="+$("#tipoPauta").val()+"&resultPauta="+$("#resultPauta").val();
      })
      ...
      $(".visualizadorMapa").click(function(){
          ...
          +"&idPDisciplina="+$("#listaDisciplinas").val();
      })
