<?php session_start();
    ...
    includar("../../");
    $manipulacaoDados = new manipulacaoDados( "Pauta Geral", "pautaGeral1");
...
<body>
  ...
  <section id="main-content">
        <section class="wrapper" id="containers">
           <div class="row" >
              ...
              <nav role="navigation" class="navbar navbar-inverse paternSubMenuInterno" >
                  ...
                  <h1 class="lead navbar-brand" style="color: white;"><i class="fa fa-table"></i><strong id="pGeral"> Pauta Geral</strong></h1>
            </nav>
            </div>
          </div>
          <div class="main-body">
        ...
        if($verificacaoAcesso->verificarAcesso("", "pautaGeral1", array(), "")){
...
<div class="card">
  <div class="card-body">
    ...
    <div class="row">
      <div class="col-lg-12 col-md-12" style="line-height:20px;">

        <a class="btn-primary btn" href="#" id="visualizarMiniPauta"><i class="fa fa-print"></i> Mini-Pauta</a>
          &nbsp;&nbsp;&nbsp;<a class="btn-primary btn" href="../../relatoriosPdf/mapaAlunosQueTransitaram.php?classe=<?php echo $classe ?>&idPCurso=<?php echo $idCurso; ?>"><i class="fa fa-print"></i> Alunos que transitaram</a>
        ...
        <a class="btn-success btn" href="calcular.php?classe=<?php echo $classe; ?>&idPCurso=<?php echo $idCurso; ?>&turma=<?php echo $turma; ?>"><i class="fa fa-spinner"></i> Calcular</a>
      </div>
    </div><br>
    <div class="row">
      ...
      <form class="modal-dialog" id="publicarPautasForm" method="post">
          <div class="modal-content">
              <div class="modal-header">
                  ...
                  <h4 class="modal-title lead font-weight-bolder" id="myModalLabel"><i class="fa fa-eye"></i> Visualização de Pautas</h4>
              </div>
                ...
                <h2 class="text-success font-weight-bolder" id="referenciaVisualizacao">PAUTA</h2>
                  ...
                  <div class="row">
                    ...
                    <?php ?>
                      <div class="col-lg-3 col-md-3 lead">
                        Pagamentos de:
                        <select class="form-control lead" id="mesPagamentoApartir">
                          <?php
                            echo '<option class="lead" value="0">Todos</option>';
                            foreach($manipulacaoDados->mesesAnoLectivo as $m){
                              echo '<option class="lead" value="'.$m.'">'.nomeMes($m).'</option>';
                            }
                          ?>
                          </select>
                      </div>
              ...
              <div class="modal-footer">
                  <div class="row">
                    <div class="col-lg-12 col-md-12 text-left">
                        <button type="button" class="btn btn-primary lead visualizarPauta" tipo="XYM">
