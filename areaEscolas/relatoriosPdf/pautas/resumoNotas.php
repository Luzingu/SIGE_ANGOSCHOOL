<?php
    ...
    class resumoNotas extends funcoesAuxiliares{
        ...
        foreach($this->disciplinasDaClasse as $disc){
            ...
            foreach($this->camposAvaliacaoAlunos($this->idPAno, $this->idPCurso, $this->classe, $this->periodoTurma, $disc["idPNomeDisciplina"], $this->trimestreAbr, "cabecalho") as $humb){
                ...
                if(($this->trimestreApartir == 4 && ($humb["identUnicaDb"] =="mf" || $humb["identUnicaDb"] =="cfd" || $humb["identUnicaDb"] =="recurso")) || ($this->trimestreApartir !=4 && ($humb["identUnicaDb"] =="mtI" || $humb["identUnicaDb"] =="mtII" || $humb["identUnicaDb"] =="mtIII")))
                {
        ...
        foreach ($alunos as $aluno) {
            ...
            $this->html .="<div style='margin-top:".$mTop."px; width:30%; margin-left: 70%; margin-bottom:20px;'>
            ...
            $tamanhoLetras=8;
            if(count($this->disciplinasDaClasse)>12){
                $tamanhoLetras=7;
            }
            ...
            $this->html .="<td style='".$this->text_center.$this->bolder.$this->border()."' rowspan='3'>RES.</td>";
