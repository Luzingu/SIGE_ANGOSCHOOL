<?php 
    ...
    class ensinoMedioLiceu extends funcoesAuxiliares{
        ...
        public function declaracaoSemNotas(){
            ...
            <body>
            <div style='margin:15px; margin-bottom:0px; height:1000px;'>".$this->fundoDocumento("../../../");;
        ...
        public function declaracao(){
            ...
            foreach ($notas as $nota) {
                if($nota["idPNomeDisciplina"]!=54 || $_SESSION['idEscolaLogada'] == 18){
            ...
            if($_SESSION['idEscolaLogada'] == 11)
                $this->html .= "<div style='height:1050px; border: solid black 4px;'>";
            else
                $this->html .= "<div style='height:1055px;'>
            <img src='".$_SERVER['DOCUMENT_ROOT']."/angoschool/icones/sombraGeral.png' style='position:absolute; margin-left:-40px; margin-top:-40px; width:780px; height:1075px;'>".$this->fundoDocumento("../../../");
            ...
            $this->html .= $this->vistoDirectorMunicipal(45, $qrCode)."<div class='cabecalho'>
                ...
                <div class='p12' style='margin-top:-30px; padding:10px;'>
                    <p style='line-height: 20px;".$this->text_justify."'>a) <span style='".$this->bolder.$this->sublinhado.$this->maiuscula."'>".$this->nomeDirigente(7)."</span>, Director d".$this->art1Escola." ".valorArray($this->sobreUsuarioLogado, "nomeEscola");
            ...
            $this->html .="</table></div>
                <p style='padding-left:10px; padding-right:10px;".$this->text_justify."'>A presente Declaração destina-se para <strong>".$this->efeitoDeclaracao."</strong>.</p>

                <p  style='padding-left:10px; line-height:21px; padding-right:10px;".$this->text_justify."'>Por ser verdade e me ter sido solicitada e assim constar nos documentos que ficam arquivados na Secretaria, mandei passar a presente declaração que vai por mim assinada e autenticada com o ";
                if($_SESSION['idEscolaLogada']==22){
                 $this->html .="selo branco em uso neste ";
                }else{
                    $this->html .="carimbo a óleo em uso neste ";
                }

                if($_SESSION["idEscolaLogada"]==27){
                    $this->html .="Estabelecimento de Ensino.";
                }else{
                    $this->html .="Liceu.";
                }
                $this->html .="</p><p style='padding-left:10px; padding-right:10px;".$this->text_center.$this->maiuscula."'>".$this->rodape("sim").".</p>";
                
                if($_SESSION["idEscolaLogada"]==27){
                    $this->html .="
                    <div style='margin-top: -7px;".$this->text_center."'>
                        <div style='width: 100%;'>".$this->assinaturaDirigentes(7, "", "", "", "nao", "nao", "sim")."
                        </div>
                    </div>";
                }else{
                    $this->html .="
                    <div style='margin-top: -17px;".$this->text_center."'>";
                        ...
                        if($_SESSION["idEscolaLogada"]==29){
                            $this->html .="<p style='".$this->text_center.$this->maiuscula.$this->bolder." padding-right:10px; font-size:11pt; margin-top:150px;'>C.E.P. ESPERANÇA-KAMI</p>";
                        }
        ...
        public function certificado(){
            ...
            if($this->idPMatricula==919){
                $PC = 13;
            }

            $this->html .="<html style='margin:30px; margin-right:60px; margin-left:40px; font-family: Times New Roman !important; margin-bottom:0px;'>
            <head>
                <title>Declaração de Habilitações</title>
                <style>
                    table tr td{
            ...
            if($_SESSION['idEscolaLogada'] == 11)
                ...
                $this->html .="<div style='height:1055px;'>
            <img src='".$_SERVER['DOCUMENT_ROOT']."/angoschool/icones/sombraGeral.png' style='position:absolute; margin-left:-50px; margin-top:-30px; width:800px; height:1085px;'>".$this->fundoDocumento("../../../");
            ...
            $this->html .="</table></div>
                ...
                $this->html .=", assinado por mim e autenticado com ";
                if($_SESSION['idEscolaLogada']==22){
                 $this->html .="selo branco ";
                }else{
                    $this->html .="carimbo a óleo ";
                }

                $this->html .="em uso neste Estabelecimento de Ensino.</p>
                <p style='line-height: 17px;".$this->text_center.$this->bolder.$this->maiuscula."'>".$this->rodape()."</p>
                    ...
                    <div style='margin-top: -17px;".$this->text_center."'>";
                        ...
                        <div style='width: 50%;margin-top:-300px; margin-left:50%;'>".$this->assinaturaDirigentes(7, "", "", "", "nao", "nao", "sim")."
                        </div>
                    </div>";
                    
                    if($this->viaDocumento>1){
                       $this->html .="<p style='".$this->text_right.$this->maiuscula.$this->bolder.$this->vermelha."; margin-top:72px; padding-right:10px;'>".$this->viaDocumento.".ª Via</p>";
                    }                    
           $this->html .="</div></div>
            </body></html>";
