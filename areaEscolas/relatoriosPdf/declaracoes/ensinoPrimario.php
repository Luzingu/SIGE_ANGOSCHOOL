<?php 
    ...
    class ensinoPrimario extends funcoesAuxiliares{
        ...
        public function declaracao(){
            ...
            $this->html .= $this->vistoDirectorMunicipal(45, $qrCode)."
                ...
                <div class='p12' style='margin-top:-30px; padding:10px;'>
                    <p style='line-height: 25px;".$this->text_justify."'>a) <span style='".$this->bolder.$this->sublinhado.$this->maiuscula."'>".$this->nomeDirigente(7)."</span>, Director do ".valorArray($this->sobreUsuarioLogado, "nomeEscola");
            ...
            $this->html .="</table></div>
                ...
                <p style='padding-left:10px; padding-right:10px;".$this->text_justify.$this->maiuscula."'>".$this->rodape().".</p>
        ...
        public function certificado(){
            ...
            $this->html .= $this->vistoDirectorMunicipal(45, $qrCode)."<div class='cabecalho'>
                ...
                $this->html .="<div style='margin-top:-30px; padding:10px;'>
                    <p style='line-height: 22px;".$this->text_justify."'>a) <span style='".$this->bolder.$this->maiuscula.$this->sublinhado."'>".$this->nomeDirigente(7)."</span</span>, Director do ".valorArray($this->sobreUsuarioLogado, "nomeEscola");
            ...
            $this->html .="</table></div>
                ...
                <p style='line-height: 17px;".$this->text_justify.$this->text_center.$this->bolder."'>".$this->rodape()."</p>
