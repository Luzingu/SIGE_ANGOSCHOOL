...
class ensinoMedioFilialEFTSZ extends funcoesAuxiliares{
    ...
    public function declaracao(){
        ...
        <div style='height:1055px;'>
            ...
            <p style='".$this->text_center.$this->miniParagrafo."margin-top:3px;'><img src='../../../icones/insigniaDeclaracao.jpg' class='text-center' style='width:50px; height:50px;'></p>
            <p style='".$this->text_center.$this->bolder.$this->miniParagrafo."font-size:12pt;'>REPÚBLICA DE ANGOLA</p>
            <p style='".$this->text_center.$this->bolder."font-size:12pt;'>MINISTÉRIO DA EDUCAÇÃO</p>";
            
            
            $this->html .="<p style='".$this->text_center.$this->bolder.$this->maiuscula."font-size: 12pt; margin-top:-10px; width:60%; margin-left:20%;'>".valorArray($this->sobreUsuarioLogado, "nomeEscola")."</p>
                <p style='font-size: 14pt; margin-top:-4px;".$this->bolder.$this->text_center."'>DECLARAÇÃO DE HABILITAÇÕES</p>";
            
            
            
            $this->html .="</div>
            <div class='p12' style='margin-top:-35px; padding:10px;'>
                <p style='line-height: 19px;".$this->text_justify."'>
            ...
            <table style='width:100%; font-size:11pt; margin-top:-14px;".$this->tabela."'>
        ...
        $this->html .="</table></div>
        <p style='font-size:12pt; padding-left:10px; padding-right:10px;".$this->text_justify."margin-top:2px;'>A presente Declaração destina-se para ".$this->efeitoDeclaracao.".</p>

        <p  style='font-size:12pt; margin-top:-7px; padding-left:10px; padding-right:10px;".$this->text_justify."'>Por ser verdade e me ter sido solicitada, mandei passar a presente Declaração, que vai por mim assinada e autenticada com o carimbo a óleo em uso nesta Instituição.</p>

        <p style='font-size:12pt; margin-top:-7px; padding-left:10px; padding-right:10px;".$this->text_justify."'>".$this->rodape().".</p>
        <div style='margin-top: -17px;".$this->text_center."'>"; 
        $this->nomeDirigente(8);
        $peda ="";
        if($this->nomeDirigente!=""){
    ...
    public function certificado(){
        ...
        $sobreDirectorEFTSZ = $this->selectArray("entidadesprimaria", [], ["escola.nivelSistemaEntidade"=>7, "escola.idEntidadeEscola"=>16, "escola.estadoActividadeEntidade"=>"A"], ["escola"]);

        $this->nomeDirectorEFTSZ = valorArray($sobreDirectorEFTSZ, "nomeEntidade");
        $this->tituloNomeDirectorEFTSZ = valorArray($sobreDirectorEFTSZ, "tituloNomeEntidade");
        if(valorArray($sobreDirectorEFTSZ, "generoEntidade")=="F"){
            $this->art1DirectorEFTSZ="a";
            $this->art2DirectorEFTSZ="a";
        }else{
            $this->art1DirectorEFTSZ="o";
            $this->art2DirectorEFTSZ="";
        }
        
        $sobreDPEFTSZ = $this->selectArray("entidadesprimaria", [], ["escola.nivelSistemaEntidade"=>8, "escola.idEntidadeEscola"=>16, "escola.estadoActividadeEntidade"=>"A"], ["escola"]);
        $this->nomeDPEFTSZ = valorArray($sobreDPEFTSZ, "nomeEntidade");
        $this->tituloNomeDPEFTSZ = valorArray($sobreDPEFTSZ, "tituloNomeEntidade");
        if(valorArray($sobreDPEFTSZ, "generoEntidade")=="F"){
            $this->art1DPEFTSZ="a";
            $this->art2DPEFTSZ="a";
        }else{
            $this->art1DPEFTSZ="o";
    ...
    private function certificadoSimples(){
        ...
        <body>
        <div style='border:double black 5px; margin:18px; padding-top:-15px; margin-bottom:-30px; height:1040px;'>".$this->fundoDocumento("../../../");
        ...
        $qrCode = $this->qrCode("Nome d".$this->art1." Alun".$this->art1.": ".valorArray($this->sobreAluno, "nomeAluno")."; Nome da Instituição: ".valorArray($this->sobreUsuarioLogado, "nomeEscola")."; Curso/Opção: ".$this->nomeCurso."; Número Interno: ".valorArray($this->sobreAluno, "numeroInterno")."; Média Final do Curso: ".$MFC."; Ano de Conclusão: ".$this->anoFinalizado."; Operador: ".valorArray($this->sobreUsuarioLogado, "nomeEntidade")."; Data de Emissão:".$this->dataSistema, "../../../", 110, 110);
            ...
            <div style='margin-top:-32px; padding:10px;'>
                <p style='line-height: 17px;".$this->text_justify."'><span style='".$this->bolder.$this->maiuscula."'>".$this->nomeDirectorEFTSZ."</span>, Director".$this->art2DirectorEFTSZ." da Instituto Médio Técnico de Saúde-Mbanza Kongo, criado sob o decreto Executivo nº 353/14 de 12 de Novembro, certifica que <span style='".$this->bolder.$this->vermelha.$this->maiuscula."'>".valorArray($this->sobreAluno, "nomeAluno")."</span>, filh".$this->art1." de ".valorArray($this->sobreAluno, "paiAluno")." e de ".valorArray($this->sobreAluno, "maeAluno").", natural ".valorArray($this->sobreAluno, "preposicaoComuna2")." ".valorArray($this->sobreAluno, "nomeComuna").", Município ".valorArray($this->sobreAluno, "preposicaoMunicipio2")." ".valorArray($this->sobreAluno, "nomeMunicipio").", Província ".valorArray($this->sobreAluno, "preposicaoProvincia2")." ".valorArray($this->sobreAluno, "nomeProvincia").", nascid".$this->art1." aos ".dataExtensa(valorArray($this->sobreAluno, "dataNascAluno")).", ".$this->identificacaoAluno.", concluiu no ano lectivo ".$this->anoFinalizado." o <strong>II CICLO DO ENSINO SECUNDÁRIO TÉCNICO</strong>, do curso de <strong>".$this->nomeCurso."</strong>, na Área de <strong>".$this->areaFormacaoCurso."</strong> n".$this->art1Escola." <strong style='".$this->maiuscula."'>".valorArray($this->sobreUsuarioLogado, "nomeEscola")."</strong>, conforme o disposto na alínea f) do artigo 109.º da LBSEE 17/16, de 7 de Outubro, com a Média Final de <strong>".$MFC."</strong> valores obtidas nas seguintes classificações por disciplina:</p>
        ...
        $this->html .="</table></div>
            ...
            <p style='line-height: 17px;".$this->maiuscula.$this->text_justify."margin-top:3px;'>Instituto Médio Técnico de Saúde-Mbanza Kongo, em Mbanza Kongo, aos ".dataExtensa($this->dataSistema).".</p>

                <div style='margin-top: -17px;".$this->text_center."'>
                    <div style='width: 50%;'>".$this->porAssinatura("Conferido por", $this->nomeDPEFTSZ."<br/>(Subdirector".$this->art2DPEFTSZ." Pedagógic".$this->art1DPEFTSZ.")", "", strlen($this->nomeDPEFTSZ))."
                    </div>
                    <div style='width: 50%;margin-top:-300px; margin-left:50%;'>".$this->porAssinatura(strtoupper($this->art1DirectorEFTSZ)." Director".$this->art2DirectorEFTSZ, $this->tituloNomeDirectorEFTSZ, "", strlen($this->tituloNomeDirectorEFTSZ))."
                    </div>
                </div>";
    ...
    private function certificadoMais18Disciplinas(){
        ...
        <body>
        <div style='height:1055px;'>
            <img src='".$_SERVER['DOCUMENT_ROOT']."/angoschool/icones/sombraGeral.png' style='position:absolute; margin-left:-40px; margin-top:-47px; width:800px; height:1152px;'>";
        

        $qrCode = $this->qrCode("Nome d".$this->art1." Alun".$this->art1.": ".valorArray($this->sobreAluno, "nomeAluno")."; Nome da Instituição: ".valorArray($this->sobreUsuarioLogado, "nomeEscola")."; Curso/Opção: ".$this->nomeCurso."; Número Interno: ".valorArray($this->sobreAluno, "numeroInterno")."; Média Final do Curso: ".$MFC."; Ano de Conclusão: ".$this->anoFinalizado."; Operador: ".valorArray($this->sobreUsuarioLogado, "nomeEntidade")."; Data de Emissão:".$this->dataSistema, "../../../", 110, 110);
            $this->html .= $this->vistoDirectorMunicipal(45, $qrCode)."<div class='cabecalho'>
                <p style='".$this->text_center.$this->miniParagrafo."margin-top:2px;'><img src='../../../icones/insigniaDeclaracao.jpg' class='text-center' style='width:55px; height:55px;'></p>
                <p style='".$this->text_center.$this->miniParagrafo.$this->maiuscula."'  style='font-size:12pt;'>República de Angola</p>
            ...
            <p style='line-height: 17px;".$this->text_justify."'><span style='".$this->bolder.$this->maiuscula."'>".$this->nomeDirectorEFTSZ."</span>, Director".$this->art2DirectorEFTSZ." do Instituto Médio Técnico de Saúde-Mbanza Kongo, criado sob o decreto Executivo nº 353/14 de 12 de Novembro, certifica que <span style='".$this->bolder.$this->vermelha.$this->maiuscula."'>".valorArray($this->sobreAluno, "nomeAluno")."</span>, filh".$this->art1." de ".valorArray($this->sobreAluno, "paiAluno")." e de ".valorArray($this->sobreAluno, "maeAluno").", natural ".valorArray($this->sobreAluno, "preposicaoComuna2")." ".valorArray($this->sobreAluno, "nomeComuna").", Município ".valorArray($this->sobreAluno, "preposicaoMunicipio2")." ".valorArray($this->sobreAluno, "nomeMunicipio").", Província ".valorArray($this->sobreAluno, "preposicaoProvincia2")." ".valorArray($this->sobreAluno, "nomeProvincia").", nascid".$this->art1." aos ".dataExtensa(valorArray($this->sobreAluno, "dataNascAluno")).", ".$this->identificacaoAluno.", concluiu no ano lectivo ".$this->anoFinalizado." o <strong>II CICLO DO ENSINO SECUNDÁRIO TÉCNICO</strong>, do curso de <strong>".$this->nomeCurso."</strong>, na Área de <strong>".$this->areaFormacaoCurso."</strong> n".$this->art1Escola." <strong style='".$this->maiuscula."'>".valorArray($this->sobreUsuarioLogado, "nomeEscola")."</strong>, conforme o disposto na alínea f) do artigo 109.º da LBSEE 17/16, de 7 de Outubro, com a Média Final de <strong>".$MFC."</strong> valores obtidas nas seguintes classificações por disciplina:</p>
        ...
        $this->html .="</table></div>
            ...
            <p style='line-height: 17px;".$this->text_justify."margin-top:-5px; font-size:11pt;'>Instituto Médio Técnico de Saúde-Mbanza Kongo, em Mbanza Kongo, aos ".dataExtensa($this->dataSistema).".</p>
