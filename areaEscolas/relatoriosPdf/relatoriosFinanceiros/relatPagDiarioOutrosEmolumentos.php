<?php if(session_status()!==PHP_SESSION_ACTIVE){
    ...
    class lista extends funcoesAuxiliares{
        ...
        function __construct($caminhoAbsoluto){
            parent::__construct("Relatório Diário de Pagamentos de Outros Emolumentos");
         ...
         private function visualizar(){
                ...
                $this->html .="
                <p style='".$this->text_center.$this->maiuscula.$this->bolder."'>RESUMO DE PAGAMENTOS DE OUTROS<br>EMOLUMENTOS - ".dataExtensa($this->dataHistorico)."</p>";
            ...
            $this->exibir("", "Relatório diário - ".$this->dataSistema);
        }
