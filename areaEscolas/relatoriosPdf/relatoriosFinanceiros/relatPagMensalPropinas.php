    ...
    class lista extends funcoesAuxiliares{
        ...
        function __construct($caminhoAbsoluto){
            ...
            $this->anoCivil = isset($_GET["anoCivil"])?$_GET["anoCivil"]:"";
             ...
             $this->html="<html style='margin-left:30px;margin-right:40px;'>
            <head>
         ...
         private function visualizar(){
                ...
                $this->html .="<br>DO MÊS DE ".nomeMes($this->mesPagamento)." -  ".$this->anoCivil."</p>
                ";
                ...
                foreach(distinct2($this->todosPagamentos, "idPMatricula") as $idPMatricula){
                    ...
                    $this->html .="<tr>
                        ...
                        <td style='".$this->border()."font-size:9pt;'>".$this->retornarMeses($idPMatricula)."</td>
            ...
            $this->exibir("", "Resumo de Pagamentos de Comparticipações-".$this->numAno);
        }
