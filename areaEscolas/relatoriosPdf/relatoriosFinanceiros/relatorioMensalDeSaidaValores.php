<?php if(session_status()!==PHP_SESSION_ACTIVE){
    ...
    class lista extends funcoesAuxiliares{
        ...
        function __construct(){
            parent::__construct("Relatório Mensal de Saídas de Valores");
         ...
         private function visualizar(){
            ...
            $this->html .="
            <p style='".$this->text_center.$this->maiuscula.$this->bolder."'>SAÍDAS DE VALORES DO MÊS DE ".nomeMes($this->mesPagamento)." -  ".$this->anoCivil."</p>";
            ...
            foreach($this->selectArray("facturas", [], ["idFacturaEscola"=>$_SESSION['idEscolaLogada'], "dataEmissao"=>new \MongoDB\BSON\Regex($this->anoCivil."-".completarNumero($this->mesPagamento)."-"), "estadoFactura"=>"A", "tipoFactura"=>"RP"], [], "", [], array("idPFactura"=>1)) as $fact){ 
                $i++;
                $itens="";
            ...
            $this->exibir("", "Saída de Valores - ".nomeMes($this->mesPagamento), "", "A4", "landscape");
        }
