           ...
           $totF=0;
            ...
            <table style='".$this->tabela." width:100%;'>
                    <tr style='".$this->corDanger."'>
                        <td style='".$this->text_center.$this->bolder.$this->bolder.$this->border()."'>N.º</td><td style='".$this->text_center.$this->bolder.$this->bolder.$this->border()."'>Código do Aluno</td><td style='".$this->text_center.$this->bolder.$this->bolder.$this->border()."'>NOTA1</td><td style='".$this->text_center.$this->bolder.$this->border()."'>NOTA2</td><td style='".$this->text_center.$this->bolder.$this->border()."'>NOTA3</td><td style='".$this->text_center.$this->bolder.$this->border()."'>MÉDIA</td>
                    </tr>
                ";
            $n=0;
            foreach ($alunos as $aluno) {
                $n++;
                $this->html .="<tr><td style='".$this->text_center.$this->border()."'>".completarNumero($n)."</td><td style='".$this->border().$this->text_center."padding-left:5px;'>".$aluno["codigoAluno"]."</td><td style='".$this->text_center.$this->border()."'></td><td style='".$this->text_center.$this->border()."'></td><td style='".$this->text_center.$this->border()."'></td><td style='".$this->text_center.$this->border()."'></td></tr>";
            } 
