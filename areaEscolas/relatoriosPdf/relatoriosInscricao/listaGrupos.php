    ...
    class lista extends funcoesAuxiliares{
        ...
        function __construct($caminhoAbsoluto){
         ...
         private function listaInscritos(){
           ...
           $alunos = $this->selectArray("alunos", ["nomeAluno", "dataNascAluno", "sexoAluno"], ["idAlunoAno"=>$this->idPAno, "idAlunoEscola"=>$_SESSION['idEscolaLogada'], "grupo.idGrupoCurso"=>$this->idPCurso, "grupo.grupoNumero"=>$this->grupo], ["grupo"],"", [], array("nomeAluno"=>1));
           ...
           $totF=0;
            ...
            <p style='".$this->maiuscula."'>HORA DO EXAME:____________ Á ___________&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SALA N.º:__________</p>

            <table style='".$this->tabela." width:100%;'>
                    <tr style='".$this->corDanger."'>
                        <td style='".$this->text_center.$this->bolder.$this->bolder.$this->border()."'>N.º</td><td style='".$this->text_center.$this->bolder.$this->bolder.$this->border()."'>Nome Completo</td><td style='".$this->text_center.$this->bolder.$this->bolder.$this->border()."'>Sexo</td><td style='".$this->text_center.$this->bolder.$this->border()."'>Idade</td>
                    </tr>
                ";
            $n=0;
            foreach ($alunos as $aluno) {
                $n++;
                $this->html .="<tr><td style='".$this->text_center.$this->border()."'>".completarNumero($n)."</td><td style='".$this->border()."padding-left:5px;'>".$aluno["nomeAluno"]."</td><td style='".$this->text_center.$this->border()."'>".generoExtenso($aluno["sexoAluno"])."</td><td style='".$this->text_center.$this->border()."'>".calcularIdade(explode("-", $this->dataSistema)[0], $aluno["dataNascAluno"])." Anos</td></tr>";
            } 
