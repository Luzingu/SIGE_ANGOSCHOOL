<?php session_start();
    ...
    }else if(count($areas)<=0 || $idPArea==7 || $idPArea==8 || $idPArea==1 || $idPArea==2){
    ...
    if($idPArea == 14)
      echo "<script>window.location ='".$manipulacaoDados->enderecoArquivos."areaEscolas/areaTickets/index.php'</script>";
