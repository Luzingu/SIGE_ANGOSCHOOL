  ...
  <section id="main-content"> 
       ...
       <table id="example1" class="table table-striped table-bordered table-hover" >
          <thead class="corPrimary">
              <tr>
                <td class="lead"><strong>Nome do Auno</strong></td><td class="lead"><strong>Alterado pelo</strong></td><td class="lead text-center" style="width: 200px;"><strong>Data da Alteração</strong></td>
                <td colspan="2" class="lead text-center"><strong>Alterações</strong></td>
              </tr>
