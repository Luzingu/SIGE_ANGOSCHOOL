<?php 
    ...
    includar("../../");
    $manipulacaoDados = new manipulacaoDados("Mini-Pautas Professor", "avaliacoesContinuas33");
  ...
  <section id="main-content"> 
    <section class="wrapper" id="containers">
      <div class="row" >
          ...
          <h1 class="lead navbar-brand" style="color: white;"><strong><i class="fa fa-pen"></i> <?php 
            echo "AVALIAÇÕES CONTÍNUAS ";
            if($trimestre=="I" || $trimestre=="II" || $trimestre=="III"){
  ...
  <div class="main-body">
      ...
      <div class="col-lg-5 col-md-5 lead" id="pesqUsario">
        Disciplinas
          <select id="referenciaDisciplina" name="referenciaDisciplina" class="form-control">
           <?php
              $array = $manipulacaoDados->selectArray("divisaoprofessores", ["classe", "sePorSemestre", "designacaoTurmaDiv", "nomeDisciplina", "abrevCurso", "abreviacaoDisciplina2", "periodoTurmaDiv", "semestre", "idPNomeDisciplina", "idPNomeCurso", "nomeTurmaDiv", "areaFormacaoCurso", "nomeCurso", "tipoCurso"], [ "idPEscola"=>$_SESSION['idEscolaLogada'],"idDivAno"=>$manipulacaoDados->idAnoActual, "idPEntidade"=>$_SESSION['idUsuarioLogado'], "avaliacoesContinuas"=>"A"]);
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-4 lead">
        ...
        <h4><a href="#" id="visualizarMiniPauta" class=" btn-primary btn lead"><i class="fa fa-print"></i> Mapa de Avaliações</a></h4>
      </div>
    </div>

    <div class="row">
      <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6">
        <label class="lead">N.º de Avaliações</label><br>
        <select class="form-control text-center" name="numeroAvalContinuas" id="numeroAvalContinuas">
      ...
      <div class="col-lg-10 col-md-10 col-xs-6 col-sm-6 text-right">
...
<?php 
  $conexaoFolhas->folhasJs(); $janelaMensagens->funcoesDaJanelaJs(); $includarHtmls->dataList(); $includarHtmls->formTrocarSenha();
 ?>
