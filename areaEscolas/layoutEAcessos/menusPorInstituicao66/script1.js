...
window.onload=function(){
    ...
    $("#btnAlterar").click(function(){
      ...
      $("#tabela tr td select").each(function(){
        dadosEnviar.push({idPMenu:$(this).attr("idPMenu"),
          idAreaEspecifica:$(this).attr("idAreaEspecifica"), idPArea:$(this).val(),
          ordemMenu:$("#ordem_"+$(this).attr("idPMenu")).val()})
      })
...
function fazerPesquisa(){
  ...
  listaMenus.filter(condicao).forEach(function(dado){
    ...
    || (idPArea=="" && (manoPeki==null || manoPeki==undefined || manoPeki=="" || manoPeki=="-1"))){
      ...
      i++;
      tbody +="<tr><td class='lead text-center'><input type='number' class='form-control text-center' value='"+
