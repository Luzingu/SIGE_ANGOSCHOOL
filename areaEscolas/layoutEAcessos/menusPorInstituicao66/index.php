...
<body>
  ...
  <section id="main-content">
        ...
        <?php  if($verificacaoAcesso->verificarAcesso(0, array(), array(), "msg")){
          ...
          echo "<script>var listaMenus = ".$manipulacaoDados->selectJson("menus", [], ["instituicao"=>valorArray($manipulacaoDados->sobreEscolaLogada, "tipoInstituicao")], [], "", [], array("designacaoMenu"=>1))."</script>";

          $areas = $manipulacaoDados->selectArray("areas", [], ["instituicoes.idEscola"=>$_SESSION['idEscolaLogada'], "idPArea"=>array('$nin'=>[7,8])], ["instituicoes"], "", [], array("ordemPorDefeito"=>1));
