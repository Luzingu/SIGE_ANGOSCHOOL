<?php session_start();
    ...
    includar("../../");
    $manipulacaoDados = new manipulacaoDados("Efectuar Pagamentos de Propinas", "efectuarPagamentos77");
          ...
          <div class="row">
              <div class="col-lg-12 col-md-12">
                <nav role="navigation" class="navbar navbar-inverse paternSubMenuInterno" > 
                    ...
                    <h1 class="lead navbar-brand" style="color: white;"><strong><i class="fa fa-check"></i> Efectuar Pagamentos</strong></h1>
                </nav>
              </div>
          </div>
          <div class="main-body">
        <?php  if($verificacaoAcesso->verificarAcesso("", ['efectuarPagamentos77'], array(), "msg")){ 
          ...
          foreach($manipulacaoDados->mesesAnoLectivo as $mes){
            ...
            if(valorArray($manipulacaoDados->sobreEscolaLogada, "comEducacaoInfantil")=="sim"){

              for($i=1; $i<=2; $i++){
                $valorPreco = valorArray(listarItensObjecto($manipulacaoDados->sobreEscolaLogada, "emolumentos", ["classe=*".$i, "mes=".$mes, "idTipoEmolumento=1"]), "valor");
                if((int)$valorPreco>0){
                  $mesesParaPagar[]=array("mes"=>$mes, "posicao"=>$posicaoMes, "valorPreco"=>$valorPreco, "classe"=>"*".$i, "idPCurso"=>"");
                }
              }
            }
      ...
      <form class="modal-dialog" id="formPagamento" method="POST">
          <div class="modal-content">
              <div class="modal-header">
                  ...
                  <h7 class="modal-title lead font-weight-bolder" id="myModalLabel"><i class="fa fa-money-bill"></i> Pagamentos</h7>
              </div>
              <div class="modal-body" style="padding-left: 40px; padding-right: 40px;">
                    ...
                    <div class="row">
                      <div style="font-size:20pt; border:solid rgba(0, 0, 0, 0.3) 1px; padding:3px;" class="text-center col-lg-12">
                        <img src="../../../fotoUsuarios/aluno0146LUZL2020.jpg" id="fotoAluno" style="height:70px; width: 70px; border-radius: 50%;">&nbsp;&nbsp;&nbsp;<strong class="text-success" id="nomeAluno">Afonso Luzingu</strong>                      
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-lg-12 col-md-12 divBorder " style="padding-bottom: 5px; padding-top:15x;">
                        ...
                        <div class="col-lg-3 col-md-3">
                          ...
                          <select class="form-control" id="idPAno" name="idPAno">
                          <?php 
                        ...
                        <div class="col-lg-3 col-md-3 text-center">
                          <label>N.º Meses</label>
                          <select class="form-control text-center" required name="quantMes" id="quantMes">
                    ...
                    <div class="row">
                      <div class="col-lg-12 col-md-12 divBorder" style="padding-bottom: 10px; padding-top:15x;">
                        ...
                        <div class="col-lg-4 col-md-4 text-center">
                          <strong>Multa</strong>
                          <input class="form-control text-center" required="" type="number" step="5" name="valorMulta" id="valorMulta" min="0">
                        </div>
                        <div class="col-lg-4 col-md-4 text-center">
                    ...
                    <input type="hidden" name="valorPropina" id="valorPropina">
