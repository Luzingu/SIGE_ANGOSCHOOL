<?php session_start();
    ...
    includar("../../");
    $manipulacaoDados = new manipulacaoDados("Recibos Anulados", "recibosAnulados");
          ...
          <div class="row">
            <div class="col-lg-12 col-md-12">
              <nav role="navigation" class="navbar navbar-inverse paternSubMenuInterno" > 
                  ...
                  <h1 class="lead navbar-brand" style="color: white;"><strong><i class="fa fa-print"></i> Recibos Anuladas</strong></h1>
              </nav>
            </div>
        </div> 
        <div class="main-body">
        <?php  if($verificacaoAcesso->verificarAcesso("", "recibosAnulados", array(), "msg")){
        ...
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-md-12 col-lg-12">
              <a href="../../relatoriosPdf/relatoriosFinanceiros/listaFacturasDiaria.php?dataHistorico=<?php echo $manipulacaoDados->dataSistema; ?>&estadoDocumento=A" class="btn btn-primary"><i class="fa fa-print"></i> Relatório Diário</a>
              &nbsp;&nbsp;&nbsp;
              <a href="../../relatoriosPdf/relatoriosFinanceiros/listaFacturasMensal.php?mesPagamento=<?php echo $mesPagamento; ?>&anoCivil=<?php echo $anoCivil; ?>&estadoDocumento=A" class="btn btn-primary"><i class="fa fa-print"></i> Relatório Mensal</a>
            </div>
          </div>        
