    ...
    class manipulacaoDadosDoAjaxInterno extends manipulacaoDadosAjax{
        ...
        private function actualizarAvaliacoes(){
            ...
            if($this->cursoAfectar==1){
                ...
                $condicaoDisciplina2["idDiscCurso"]=array('$in'=>$luzl);
            }
            ...
            $this->editarItemObjecto("nomedisciplinas", "disciplinas", "cabecalhoAvaliacoes-".$this->idPAno.", cabecalhoAvaliacoesExt-".$this->idPAno, [$this->conjuntoDados, $this->conjuntoDadosExt], $condicaoDisciplina, $condicaoDisciplina2);
