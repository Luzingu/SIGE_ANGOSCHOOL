<?php session_start();
    ...
    includar("../../");
    $manipulacaoDados = new manipulacaoDados("Cabecalho de Avaliações por Disciplina", "cabecalhoAvaliacoesPorDisciplina");
          ...
          <div class="row">
            <div class="col-lg-12 col-md-12">
              <nav role="navigation" class="navbar navbar-inverse paternSubMenuInterno" > 
                  ...
                  <h1 class="lead navbar-brand" style="color: white;"><strong><i class="fa fa-info-circle"></i> Cabeçalho por Disciplina</strong></h1>
              </nav>
            </div>
        </div>
        <div class="main-body">
        <?php  if($verificacaoAcesso->verificarAcesso("", "cabecalhoAvaliacoesPorDisciplina", array(), "msg")){
  ...
  <form class="modal-dialog" id="formularioAvaliacoesForm">
    <div class="modal-content">
      <div class="modal-header">
          ...
          <h4 class="modal-title lead font-weight-bolder" id="myModalLabel"><i class="fa fa-info-circle"></i> Cabeçalho</h4>
      </div>
