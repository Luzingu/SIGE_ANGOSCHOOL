<?php session_start();
    ...
    includar("../../");
    $manipulacaoDados = new manipulacaoDados("Cabecalho de Avaliações por Classe", "cabecalhosAvaliacoesPorClasse");
          ...
          <div class="row">
            <div class="col-lg-12 col-md-12">
              <nav role="navigation" class="navbar navbar-inverse paternSubMenuInterno" > 
                  ...
                  <h1 class="lead navbar-brand" style="color: white;"><strong><i class="fa fa-info-circle"></i> Cabecalhos por Classe</strong></h1>
              </nav>
            </div>
        </div>
        <div class="main-body">
        <?php  if($verificacaoAcesso->verificarAcesso("", "cabecalhosAvaliacoesPorClasse", array(), "msg")){
          ...
          echo "<script>var listaCursos =".$manipulacaoDados->selectJson("nomecursos", [], ["cursos.idCursoEscola"=>$idEscola, "idPNomeCurso"=>$idPNomeCurso], ["cursos"], "", [], ["disciplinas.periodoDisciplina"=>1, "disciplinas.classeDisciplina"=>1])."</script>";
           ?>
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  <thead class="corPrimary">
                      <tr>
                        <th class="lead"><strong>Classe</strong></th>
                        <th class="lead"><strong>Cabecalho</th>
  ...
  <form class="modal-dialog" id="formularioAvaliacoesForm">
    <div class="modal-content">
      <div class="modal-header">
          ...
          <h4 class="modal-title lead font-weight-bolder" id="myModalLabel"><i class="fa fa-info-circle"></i> Cabeçalho das Avaliações</h4>
      </div>
