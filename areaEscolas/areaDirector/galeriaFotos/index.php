<?php session_start();
    ...
    includar("../../");
    $manipulacaoDados = new manipulacaoDados("Galeria de Fotos", "galeriaFotos");
...
<body>
  ...
  <section id="main-content"> 
        ...
        if($verificacaoAcesso->verificarAcesso("", ["galeriaFotos"], array(), "msg")){                                
            echo "<script>var galeriaFotos =".json_encode($manipulacaoDados->selectArray("escolas", ["fotos.idPGaleria", "fotos.fotoGaleria", "fotos.legendaFoto", "fotos.imgPrincipal", "fotos.idGaleriaEscola"], ["idPEscola"=>$_SESSION['idEscolaLogada']], ["fotos"]))."</script>";
          ?>
          <div class="row">
              ...
              <div class="modal-footer">
                  <div class="row">
                    <div class="col-lg-4 col-md-4 text-left">
                      <button ype="submit" class="btn btn-success lead btn-lg submitter" id="Cadastar"><i class="fa fa-plus"></i> Adicionar</button>
                    </div>                    
                  </div>                
              </div>
            </div>
