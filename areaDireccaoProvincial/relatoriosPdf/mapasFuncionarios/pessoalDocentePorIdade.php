         ...
         private function mapa(){
          $this->lista = $this->selectArray("entidadesprimaria LEFT JOIN dadosadicionasentidade ON idDAEntidade=idPEntidade LEFT JOIN entidade_escola ON idFEntidade=idPEntidade", "*", "estadoActividadeEntidade=:estadoActividadeEntidade AND idEntidadeEscola=:idEntidadeEscola AND tipoPessoal=:tipoPessoal AND efectividade=:efectividade", ["A", $_SESSION["idEscolaLogada"], "docente", "V"], "nomeEntidade ASC");
           $this->html="<html>
            ...
            <body>
            <div class='cabecalho'>
            <div><div style='margin-top:-20px; margin-left:50px; width:200px; position:absolute;' style='".$this->maiuscula."'>".$this->assinaturaDirigentes("Director")."</div></div>".$this->cabecalho()."<p style='".$this->text_center.$this->maiuscula.$this->sublinhado.$this->bolder."'>Idade do Pessoal Docente</p>                
            </div>
            ...
            $this->html .="</table>".$this->assinaturaDirigentes("Administrativo");
