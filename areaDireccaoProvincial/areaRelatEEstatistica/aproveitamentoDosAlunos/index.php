...
<body>
  ...
  <section id="main-content"> 
          ...
          <div class="row">
            <div class="col-lg-12 col-md-12">
              <nav role="navigation" class="navbar navbar-inverse paternSubMenuInterno" > 
                  ...
                  <h1 class="lead navbar-brand" style="color: white; font-weight: bolder;">(<?php echo $privacidade; ?>) Aproveitamento dos Alunos <?php 
                  if($trimestre=="IV"){
                    echo "Final";
                  }else{
        ...
        echo "<script>var alunosReconfirmados=".$manipulacaoDados->selectCondClasseCurso("json", "alunosreconfirmados LEFT JOIN alunosmatriculados on idReconfMatricula=idPMatricula LEFT JOIN aluno_escola ON idPMatricula=idFMatricula LEFT JOIN nomecursos ON idPNomeCurso=idMatCurso LEFT JOIN entidadesprimaria ON idPEntidade=idReconfProfessor LEFT JOIN turmas ON idTurmaMatricula=idPMatricula LEFT JOIN avaliacaoanualaluno ON idPMatricula=idAvalMatricula", "*", "idReconfAno=:idReconfAno AND idReconfEscola=:idReconfEscola AND idMatEscola=idReconfEscola AND estadoAluno in ('A', 'Y') AND classeReconfirmacao=:classeReconfirmacao AND periodoAluno=:periodoAluno AND idTurmaAno=idReconfAno AND classeReconfirmacao=classeTurma AND idAvalAno=idReconfAno", [$idPAno, $idPEscola, $classe, $periodo, $idCurso], $classe, " AND idMatCurso=:idMatCurso", "nomeAluno ASC")."</script>";
      ?>
      ...
      <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-2 col-lg-2 lead">
              Aproveitamento
              <select class="form-control" id="aproveitamento">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12">
              ...
              <a href="#" class="btn btn-primary visualizadorMapa" caminho="mapasEstaticosDeAproveitamentoDosAlunos/mapaAproveitamentoGeralPorCurso"><i class="fa fa-print"></i> Mapa de Aproveitamento Geral do <?php echo $classe>=10?"Curso":"Ciclo";?></a>
            </div> 
          </div>
          <table id="example1" class="table table-bordered table-striped">
              <thead class="corPrimary">
                  <tr>
                      ...
                      <th class="lead text-center"><strong>Aproveitamento</strong></th>
                  </tr>
              </thead>
