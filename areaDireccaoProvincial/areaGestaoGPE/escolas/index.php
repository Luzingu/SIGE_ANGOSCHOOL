          ...
          <div class="modal-content">
              ...
              <div class="modal-body">
                  ...
                  <div class="row">
                      ...
                      <div class="col-lg-3 col-md-3 lead">
                        Nível:
                        <select class="form-control lead" name="nivelEscola" id="nivelEscola">
                  ...
                  <div class="row">
                      <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 lead">
                        ...
                        <select class="form-control lead" id="periodosEscolas" name="periodosEscolas" required>
                            <option class="lead" value="reg">Somente Regular</option>
                      ...
                      <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 lead">
                        Tipo de Pacote:
                        <select class="form-control lead" id="tipoPacoteEscola" name="tipoPacoteEscola" required>
                            <option class="lead">Especialista</option>
                            <option class="lead">Explorador</option>
                        </select>
                      </div>
                      <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 lead">
                        Estado:
