<?php session_start(); 
  if(!isset($_SESSION["directorioPaterno"])){
    ...
    $manipulacaoDados = new manipulacaoDados(__DIR__, "Adicionar Funcionário");
          ...
          <div class="row">
            <div class="col-lg-12 col-md-12">
              <nav role="navigation" class="navbar navbar-inverse paternSubMenuInterno" > 
                  ...
                  <h1 class="lead navbar-brand" style="color: white;"><strong><i class="fa fa-user-plus"></i> Adicionar Funcionários</strong></h1>
              </nav>
            </div>
        </div>
        <div class="main-body">
