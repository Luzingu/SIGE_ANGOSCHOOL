<?php session_start();       
    ...
    $manipulacaoDados = new manipulacaoDados(__DIR__, "CPainel - Lista dos Agentes");
...
<body>
  ...
  <section id="main-content">
        ...
        <div class="main-body">
        <?php  if($verificacaoAcesso->verificarAcesso(["aGestGPE"], "", "", valorArray($manipulacaoDados->sobreUsuarioLogado, "tipoPacoteEscola"))){
