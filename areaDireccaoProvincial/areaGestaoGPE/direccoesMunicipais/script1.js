window.onload = function(){
  ...
  fecharJanelaEspera();
    entidade ="escolas";
    directorio = "areaGestaoGPE/direccoesMunicipais/";
...
function fazerPesquisa(){
    ...
    listaEscolas.forEach(function(dado){
      ...
      $("#numTActivo").text(completarNumero(numEscolaA));
          ...
          "<td class='lead'>"+vazioNull(dado.nomeMunicipio)+"<br/>"+vazioNull(dado.nomeComuna)
          +"</td><td class='lead'>"+dado.endereco+"</td><td class='lead text-center'>"+dado.estadoEscola
