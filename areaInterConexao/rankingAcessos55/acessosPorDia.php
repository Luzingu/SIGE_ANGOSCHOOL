<?php session_start();
    ...
    includar("../../");
    $manipulacaoDados = new manipulacaoDados("Acessos por Dia");
          ...
          <div class="row">
            <div class="col-lg-12 col-md-12">
              <nav role="navigation" class="navbar navbar-inverse paternSubMenuInterno" > 
                  ...
                  <h1 class="lead navbar-brand" style="color: white;"><strong><i class="fa fa-star"></i> Ranking de Acessos por Dia</strong></h1>
              </nav>
            </div>
        </div>
        <div class="main-body">
        <?php  if($verificacaoAcesso->verificarAcesso(11, ["qualquerAcesso"], array(), "msg")){
         ...
         ?>
                ...
                <select class="form-control lead" id="idDataInicial">
                    <?php 
                        ...
                        foreach ($datasEntradas as $data) {
                          $i++;
                          if($i==1){ 
                            $idDataInicial = $manipulacaoDados->selectUmElemento("entidadesonline", "idPOnline", ["dataEntrada"=>$data]);
                          }
          ...
          <?php
            ...
            $arrayFinal=array();
            foreach ($manipulacaoDados->selectDistinct("entidadesonline", "dataEntrada", ["idPOnline"=>array('$gte'=>$idDataInicial ), "idPOnline"=>array('$lte'=>$idDataFinal)], []) as $acesso) {
            ...
            foreach ($arrayFinal as $ar) {
              ...
              $ar["ordem"]=($i);
              if($i<=$topAcessos){
                $arrayFinalComOrdenacao[] = array('dataEntrada'=>$ar["dataEntrada"], "Dias"=>$ar["Dias"], "Horas"=>$ar["Horas"], "Minutos"=>$ar["Minutos"], "Segundos"=>$ar["Segundos"], "totalSegundos"=>$ar["totalSegundos"], "ordem"=>$i);
              }else{
                break;
              }
            } 
                ...
                <table class="table table-striped table-bordered table-hover" >
                    <thead class="corPrimary">
                      <tr>
                        ...
                        <th class="lead" style="width: 300px;"><strong>Data</strong></th>
                        <th class="lead"><strong>Segundos</strong></th>
...
<?php $conexaoFolhas->folhasJs(); $janelaMensagens->funcoesDaJanelaJs(); $includarHtmls->formTrocarSenha();
  ...
  function totalDeTempo($entidadesOnline, $dataEntrada){
    ...
    foreach ($entidadesOnline as $entidade) {
      ...
      if($entidade["dataEntrada"]==$dataEntrada){          
    ...
    $arayRetorno =array('dataEntrada'=>$dataEntrada, "Dias"=>$totalDia, "Horas"=>$totalHora, "Minutos"=>$totalMinuto, "Segundos"=>$totalSegundo, "totalSegundos"=>totalSegundos($totalDia, $totalHora, $totalMinuto, $totalSegundo));
...
<script type="text/javascript">
  ...
  window.onload=function(){
      ...
      directorio = "admin/rankingAcessos/";
  ...
  function fazerPesquisa(){
    ...
    if(jaTemPaginacao==false){
        paginacao.baraPaginacao(lista.length, 150);
    }else{
    ...
    lista.forEach(function(dado){
      ...
      if(contagem>=paginacao.comeco && contagem<=paginacao.final){
        ...
        +"</td><td class='lead'>"+retornDataExtensa(dado.dataEntrada)
