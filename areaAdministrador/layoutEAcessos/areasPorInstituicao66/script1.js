...
function fazerPesquisa(){
  ...
  listaAreas.forEach(function(dado){
    ...
    tbody +="<tr idPArea='"+dado.idPArea+"'><td class='lead text-center'>"
    +completarNumero(i)+"</td><td class='lead'><label><input class='estadoArea' type='checkbox' idPArea='"+dado.idPArea
    +"' "+checkedEstado+">&nbsp;&nbsp;&nbsp;"+dado.designacaoArea
    +"</label></td><td class='lead acessos'>"
...
function luzinguLuame(){
  ...
  enviarComGet("tipoAcesso=luzinguLuame&areasMarcadas="
    +JSON.stringify(areasMarcadas)+"&idPEscola="+idPEscola);
