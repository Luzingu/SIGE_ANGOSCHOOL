...
<body>
  <?php
    ...
    $coordenador = $manipulacaoDados->selectArray("entidadesprimaria", ["idPEntidade", "nomeEntidade"], ["idPEntidade"=>35]);

    $nomeProfessor="";
    $idProfessorCoordenador="";
    if(is_array($coordenador)){
      $nomeProfessor = valorArray($coordenador, "nomeEntidade");
      $idProfessorCoordenador = valorArray($coordenador, "idPEntidade");
    }
