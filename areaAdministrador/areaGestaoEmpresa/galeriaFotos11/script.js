...
window.onload = function (){
  ...
  directorio = "areaGestaoEmpresa/galeriaFotos11/";
...
function listarGaleria(){
  ...
  galeriaFotos.forEach(function(dado){
      html +="<div class='col-lg-3 col-md-4 col-sm-12 col-xs-12 divFoto'><img src='"+caminhoRecuar+"../Ficheiros/Escola_"+
