<?php session_start(); 
   include_once $_SERVER['DOCUMENT_ROOT'].'/angoschool/areaAdministrador/funcoesAuxiliares.php';
    ...
    includar("../../");
    $manipulacaoDados = new manipulacaoDados("Histórico de Conectividade", "historicoConectividade11");
...
<body>
  ...
  <section id="main-content"> 
        ...
        <div  class="main-body">
        <?php  if($verificacaoAcesso->verificarAcesso("", "historicoConectividade11", array(), "msg")){
