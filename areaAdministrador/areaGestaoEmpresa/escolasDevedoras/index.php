...
<body>
  ...
  <section id="main-content"> 
          ...
          <div class="row">
            <div class="col-lg-12 col-md-12">
              <nav role="navigation" class="navbar navbar-inverse paternSubMenuInterno" > 
                  ...
                  <h1 class="lead navbar-brand" style="color: white;"><strong><i class="fa fa-donate"></i> Escolas Devedoras</strong></h1>                  
              </nav>
            </div>
        </div>
        <div class="main-body">
        <?php  if($verificacaoAcesso->verificarAcesso("", "controlMensalPagamentos", array(), "msg")){
          ...
          $arrayDevedores=array();

          foreach($manipulacaoDados->selectArray("escolas", ["contrato.inicioPrazoPosPago", "contrato.mesesConsecutivosParaBloquear", "contrato.valorPagoPor15Dias", "nomeEscola"], ["contrato.valorPagoPor15Dias"=>array('$gt'=>0), "idPEscola"=>array('$ne'=>4)], ["contrato"]) as $a){

            $dataDivida1=valorArray($a, "inicioPrazoPosPago", "contrato");
            $dataDivida2=valorArray($a, "inicioPrazoPosPago", "contrato");
            ...
            for($i=1; $i<=20; $i++){
              ...
              if($dataDivida2<=$manipulacaoDados->dataSistema || ($i==valorArray($a, "mesesConsecutivosParaBloquear", "contrato") && $dataDivida1<=$manipulacaoDados->dataSistema )){
                $contadorMeses++;
              }else{
                break;
              }
            ...
            if($contadorMeses>0){
              $arrayDevedores[]=array("nomeEscola"=>$a["nomeEscola"], "numeroMeses"=>$contadorMeses, "valorPagoMensal"=>(floatval(valorArray($a, "valorPagoPor15Dias", "contrato"))*2), "total"=>(floatval(valorArray($a, "valorPagoPor15Dias", "contrato"))*2*$contadorMeses));
            }
          } 
          echo "<script>var arrayDevedores=".json_encode($arrayDevedores)."</script>";    
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-lg-7 col-md-7"><br>
                <span class="lead" style="font-size:20pt;">Total: <strong id="valorTotal"></strong></span>
              </div>
      ...
      <table id="example1" class="table table-striped table-bordered table-hover" >
        <thead class="corPrimary">
          <tr>
            ...
            <th class="lead text-center"><strong>N.º de Meses</strong></th> 
