<?php session_start();
    ...
    includar("../../");
    $manipulacaoDados = new manipulacaoDados("Modelo de Avaliações", "modeloAvaliacoes00");
...
<body>
  ...
  <section id="main-content">
        ...
        <div class="main-body">
        <?php  if($verificacaoAcesso->verificarAcesso("", "modeloAvaliacoes00", array(), "msg")){
          ...
          $curriculo = explode("-", $luzingu)[0];
          $idPNomeCurso = isset(explode("-", $luzingu)[1])?explode("-", $luzingu)[1]:"";
          ...
          echo "<script>var listaDisciplinas =".$manipulacaoDados->selectJson("nomedisciplinas", [], ["disciplinas.idDiscCurriculo"=>$curriculo, "disciplinas.idDiscCurso"=>$idPNomeCurso], ["disciplinas"], "", [], ["disciplinas.periodoDisciplina"=>1, "disciplinas.classeDisciplina"=>1])."</script>";
                ...
                <div class="row">
                  <div class="col-lg-2 col-md-2 lead">
                    ...
                    <select class="form-control lead" id="anosLectivos">
                      <?php
                        foreach($manipulacaoDados->selectArray("anolectivo", ["idPAno", "numAno"], ["anos_lectivos.idAnoEscola"=>1], ["anos_lectivos"], "", [], ["numAno"=>-1]) as $ano){
                      ...
                      <?php
                        foreach (["curriculo1", "curriculo2", "curriculo3"] as $c) {
                          echo "<optgroup label='".$c."'>";
                            foreach($manipulacaoDados->selectArray("nomecursos", ["idPNomeCurso", "abrevCurso"], [], [], "", [], ["nomeCurso"=>1]) as $curso)
                            {
                              echo "<option value='".$c."-".$curso["idPNomeCurso"]."'>".$curso["abrevCurso"]."</option>";
                            }
                          echo "</option>";
                        }
                      ?>
                  ...
                  <div class="col-lg-2 col-md-2 lead">
                    <label>Copiar</label>
                    <select class="form-control lead" id="anoCopiar">
                      <?php
                  ...
                  <div class="col-lg-1 col-md-1 lead text-right"><br>
                    <button id="btnCopiar" class="btn btn-success btn-lg" id="btnCopiar"><i class="fa fa-spinner"></i></button>
                  </div>
                </div>
  ...
  <form class="modal-dialog" id="formularioAvaliacoesForm">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="hidden" id="idPEscola" name="idPEscola" value="<?php echo $idPEscola; ?>">
