<?php
    ...
    curtina($_SERVER['DOCUMENT_ROOT'].'/angoschool/areaAdministrador/manipulacaoDados.php');
    ...
    curtina($_SERVER['DOCUMENT_ROOT'].'/angoschool/areaAdministrador/layoutEAcessos.php');
            ...
            <ul class="nav pull-right top-menu">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu extended logout listaMenuCima" id="informUsuario">
                  ...
                  foreach($this->selectArray("areas", ["designacaoArea", "icone", "idPArea"], ["instituicoes.idEscola"=>$_SESSION['idEscolaLogada'], "idPArea"=>array('$nin'=>[1, 7, 8])], ["instituicoes"]) as $area){

                      if($this->verificadorAcesso->verificarAcesso($area["idPArea"], ["qualquerAcesso"], array(), "")){
                      ...
                      if($area["idPArea"]==11){
                       ...
                       ?>
                        <li style="height: 46px;">
                          <a style="height: 46px;" href="<?php echo $this->enderecoArquivos."areaAdministrador/".$linkArea; ?>"><i class="<?php echo $area["icone"]; ?>"></i><?php echo $area["designacaoArea"]; ?></a>
                        </li>
                        <?php
                      }
                    }
                   ...
                   ?>
                  <li style="height: 46px;">
                    <a style="height: 46px;" href="<?php echo $this->verificadorAcesso->enderecoArquivos; ?>areaAdministrador/layoutEAcessos/index.php"><i class="fa fa-gamepad"></i> Layout e Acessos</a>
                  </li>

                  <?php if($_SESSION['idUsuarioLogado']==35 || $this->verificadorAcesso->verificarAcesso(8, ["qualquerAcesso"], array(), "")){ ?>
                    <li style="height: 46px;">
                      <a style="height: 46px;" href="<?php echo $this->verificadorAcesso->enderecoArquivos; ?>areaEntretenimento/index.php"><i class="fa fa-gamepad"></i> Entretenimento</a>
                    </li>
                  <?php } ?>
                  ...
                  <li style="height: 46px;">
                    <a style="height: 46px;" href="<?php echo $this->verificadorAcesso->enderecoArquivos; ?>areaInterConexao/usuariosConnectados55/index.php"><i class="fa fa-share-alt"></i>Inter-Conexão</a>
                  </li>

                  <li style="height: 46px;">
                    <a style="height: 46px;" href="#" id="trocarSenha"><i class="fa fa-key"></i>Alterar Senha</a>
                  </li>

                  <li style="height: 46px;">
                    <a style="height: 46px;" href="<?php echo $this->enderecoArquivos; ?>funcoesAuxiliares.php?termSessao=break"><i class="fa fa-sign-out-alt"></i> Terminar Sessão</a>
                  </li>
      ...
      ?>
        ...
        if($idPArea==0){
         ...
         <aside>
          <div id="sidebar" class="nav-collapse">
            ...
            <ul class="sidebar-menu">
              <li id="paraAnoLectivo">
                  <div class="text-center lead anoLectivo">LUZL</div>
              </li>
          <?php
            foreach($this->selectArray("menus", [], ["idAreaPorDefeito"=>$idPArea], [], "", [], ["ordenacao"=>1]) as $a){
                  ...
                  <li class="sub-menu">
                    ...
                    <ul class="sub">
                      <?php foreach($subMenus as $menu){
                        if($this->verificadorAcesso->verificarAcesso(8, [valorArray($menu, "identificadorSubMenu")], array(), "")){
                      ?>
                ...
                if($a["identificadorMenu"]=="nivelAcesso"){
                  $linkMenu ="areaEntretenimento/niveisAcesso/index.php";
                }
                if($this->verificadorAcesso->verificarAcesso(valorArray($a, "idArea", "instituicoes"), [$a["identificadorMenu"]], array(), "")){ ?>
                  <li class="sub-menu">
          ...
          <?php
             foreach($this->selectArray("menus", [], ["instituicoes.idEscola"=>$_SESSION['idEscolaLogada'], "instituicoes.idArea"=>$idPArea], ["instituicoes"], "", [], ["ordenacao"=>1]) as $a){
             ...
             ?>
              ...
              <li class="sub-menu">
                ...
                <ul class="sub">
                  <?php foreach($subMenus as $menu){
                    if($this->verificadorAcesso->verificarAcesso(valorArray($a, "idArea", "instituicoes"), [valorArray($menu, "identificadorSubMenu")], array(), "")){
                  ?>
                    <li><a class="lead" href="<?php echo $this->enderecoArquivos.$menu["linkSubMenu"]; ?>" id="novaMatricula"><?php echo $menu["designacaoSubMenu"]; ?></a></li>
                  <?php } } ?>
                </ul>
            ...
            <?php } else {
              ...
              if($a["identificadorMenu"]=="nivelAcesso"){
                ...
                $linkMenu ="areaAdministrador/areaGestaoEmpresa/niveisAcesso/index.php?idPArea=".valorArray($a, "idArea", "instituicoes");
              }
              if($this->verificadorAcesso->verificarAcesso(valorArray($a, "idArea", "instituicoes"), [$a["identificadorMenu"]], array(), "")){ ?>
                <li class="sub-menu">
                  <a href="<?php echo $this->enderecoArquivos.$linkMenu; ?>" class="" >
