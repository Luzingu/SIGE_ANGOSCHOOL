          ...
          <div class="row">
            <div class="col-lg-12 col-md-12">
              <nav role="navigation" class="navbar navbar-inverse paternSubMenuInterno" > 
                  ...
                  <h1 class="lead navbar-brand" style="color: white;"><strong><i class="fa fa-book-reader"></i> Categorias</strong></h1>
              </nav>
            </div>
        </div>
        <div class="main-body">
            <?php 
              echo "<script>var listaCategorias =".$manipulacaoDados->selectJson("categoriaLivros", [], [], [], "", [], ["idPCategoria"=>1])."</script>";
      ...
      <form class="modal-dialog" id="formularioCategoriaForm">
          <div class="modal-content">
              <div class="modal-header">
                  ...
                  <h4 class="modal-title lead font-weight-bolder" id="myModalLabel"><i class="fa fa-book-reader"></i> Categorias</h4>
              </div>
              ...
              <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 lead">
                      Categoria:
                      <input type="text" class="form-control lead" id="categoriaLivro" name="categoriaLivro" autocomplete="off">
                    </div> 
                </div>                
                <input type="hidden" name="action" id="action">
                <input type="hidden" name="idPCategoria" id="idPCategoria">
              </div>
